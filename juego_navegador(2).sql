...
--
-- Servidor: localhost
-- Tiempo de generación: 17-01-2013 a las 12:00:51
...
--
-- Volcar la base de datos para la tabla `ataques`
--
...
--
-- Volcar la base de datos para la tabla `cola_produccion`
--
...
--
-- Volcar la base de datos para la tabla `costes_construcciones`
--

INSERT INTO `costes_construcciones` (`id_costo`, `edificio`, `nivel`, `produccion`, `habitantes`, `madera`, `barro`, `hierro`, `cereal`, `tiempo`) VALUES
...
--
-- Volcar la base de datos para la tabla `datos_tropas`
--
...
(1, 'tropa1', 'legionario', 20, 50, 30, 50, 20, 70, 10, 1, 10, 70, 'infanteria', 60, 'cuartel_1'),
...
--
-- Volcar la base de datos para la tabla `edificios_aldea`
--
...
--
-- Volcar la base de datos para la tabla `intercambios`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=102 ;
...
--
-- Volcar la base de datos para la tabla `reportes_tropas`
--
...
--
-- Volcar la base de datos para la tabla `tropas`
--
...
--
-- Volcar la base de datos para la tabla `tropas_refuerzos`
--
...
--
-- Volcar la base de datos para la tabla `vuelta_ataques`
--
