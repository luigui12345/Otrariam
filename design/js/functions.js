...
$('#aldea').ready(function(){
	...
	var boton = $("#show_levels");
	var level = $(".building_level");
	var activo = false;
...
while ((new Date().getTime() - inicio) < milliseconds){
}
}
	function objetoAjax()
	{
...
function refrescar()
{
	...
	divLoad = document.getElementById('resources'); 								//Donde se mostrará los registros
